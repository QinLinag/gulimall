...
public class CategoryBrandRelationController {
    ...
    public R relationBrandsList(@RequestParam(value = "catId",required = true) Long cateId){
       List<BrandEntity> BrandEntities=categoryBrandRelationService.getBrandByCateId(cateId);
